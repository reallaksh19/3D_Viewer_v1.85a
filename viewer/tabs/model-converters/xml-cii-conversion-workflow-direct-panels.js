...
const OLD_XML_CII_WORKFLOW_PHASES = Object.freeze([
...
function oldPhaseDetailHtml(phaseId, dataRoot) {
...
export function renderXmlCiiWorkflowProcessEnrichmentPanel(target, dataRoot = document, callbacks = {}) {
  ...
  if (scheduleExactOldWorkflow(target, dataRoot, callbacks)) return;
